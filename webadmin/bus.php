...
if(isset($_GET['type']) && $_GET['type']!=='' && isset($_GET['id']) && $_GET['id']>0){
	...
	if($type=='active' || $type=='deactive'){
		...
		mysqli_query($con,"update bus_list set status='$status' where id='$id'");
	}
                ...
                <div class="table-responsive">
                    <table class="table display data-table text-nowrap">
                        ...
                        <tr role="row" class="odd">
                              ...
                              <td class="sorting_1 dtr-control"><?php echo $row['number']?></td>
                              <td>
                                 <a href="manage-bus.php?id=<?php echo $row['id']?>"><label class="badge badge-success hand_cursor">Edit</label></a>&nbsp;
                                 <?php
                                 if($row['status']==1){
                                 ?>
