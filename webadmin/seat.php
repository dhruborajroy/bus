...
$sql="SELECT seat.*, bus_list.name as bus_name from seat,bus_list where bus_list.id=seat.bus_id";
                    ...
                    <table class="table display data-table text-nowrap">
                        ...
                        ?>
                           <tr role="row" class="odd">
                              ...
                              <td>
                                 <a href="manage-seat.php?id=<?php echo $row['id']?>"><label class="badge badge-success hand_cursor">Edit</label></a>&nbsp;
                                 <?php
                                 if($row['status']==1){
                                 ?>
