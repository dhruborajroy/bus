            ...
            <div class="col-xl-3 col-sm-6 col-12">
                <div class="dashboard-summery-one mg-b-20">
                    <div class="row align-items-center">
                        ...
                        <div class="col-6">
                        <div class="item-content">
                            <div class="item-title">Approped Tickets</div>
            ...
            <div class="col-xl-3 col-sm-6 col-12">
                <div class="dashboard-summery-one mg-b-20">
                    <div class="row align-items-center">
                        ...
                        <div class="col-6">
                        <div class="item-content">
                            <div class="item-title">Buses</div>
            ...
            <div class="col-xl-3 col-sm-6 col-12">
                <div class="dashboard-summery-one mg-b-20">
                    <div class="row align-items-center">
                        ...
                        <div class="col-6">
                        <div class="item-content">
                            <div class="item-title">Drivers</div>
                ...
                <div class="card dashboard-card-three pd-b-20">
                    <div class="card-body">
                        ...
                        <div class="doughnut-chart-wrap">
                            <canvas onload="studentChart(1500,2000)" id="student-doughnut-chart" width="100" height="300"></canvas>
                        </div>
