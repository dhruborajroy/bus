...
if(isset($_GET['type']) && $_GET['type']!=='' && isset($_GET['id']) && $_GET['id']>0){
	...
	$id=get_safe_value($_GET['id']);
	// if($type=='delete'){
	// 	mysqli_query($con,"delete from place where id='$id'");
	// 	redirect('place.php');
	// }
	if($type=='active' || $type=='deactive'){
		...
		mysqli_query($con,"update place set status='$status' where id='$id'");
	}
                    ...
                    <table class="table display data-table text-nowrap">
                        ...
                        ?>
                           <tr role="row" class="odd">
                              ...
                              <td>
                                 <a href="manage-place.php?id=<?php echo $row['id']?>"><label class="badge badge-success hand_cursor">Edit</label></a>&nbsp;
                                 <?php
                                 if($row['status']==1){
                                 ?>
